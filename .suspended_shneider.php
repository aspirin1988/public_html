...
<head>
  <meta charset="utf-8">
  <title>Платный хостинг сайтов Шнайдер-хост обслуживает сайт <?php echo $_SERVER['SERVER_NAME']?></title>
 </head>
<body>
...
<table>
	<tr>
        ...
        <td>
        	<h1>Ваш хост-аккаунт с сайтом <?php echo $_SERVER['SERVER_NAME']?> был заблокирован</h1>
